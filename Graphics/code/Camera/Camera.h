...
public:
    ...
    Camera(const glm::vec3 &_position, const glm::vec3 &_front_dir, const glm::vec3 &_up_dir, float _fovy, float _yaw,
           float _pitch)
    ...
    glm::vec3 front_direction() const { return front_dir_; }

    glm::vec3 up_direction() const { return up_dir_; }

    glm::vec3 right_direction() const { return right_dir_; }
